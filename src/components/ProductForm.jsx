...
const ProductForm = ({ initialFormData = {}, onSubmit, formText }) => {
    ...
    <div className="mt-12 max-w-md mx-auto p-6 bg-white border border-gray-200 rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex space-x-4">
          ...
          <button
            type="submit"
            className="w-1/2 px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
            Submit
          </button>
        </div>
